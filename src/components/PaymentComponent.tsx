  ...
  return (
    <>
      ...
      <div className="max-w-md mx-auto bg-secondary bg-opacity-90 p-6 rounded-3xl shadow-2xl border border-gray-600/30 text-center my-8 mx-4">
        ...
        {showDisclaimer ? (
          <div className="bg-gray-800/70 p-6 rounded-2xl mb-6 border border-gray-700/50 shadow-lg">
            ...
            <div className="flex space-x-4">
              <button
                ...
                className="flex-1 py-3 bg-gray-700/80 hover:bg-gray-600/80 rounded-full shadow-lg"
              >
                Cancel
              </button>
              <button
                onClick={handleAcceptDisclaimer}
                className="flex-1 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:opacity-90 rounded-full shadow-lg font-medium"
              >
                I Understand
              </button>
            </div>
          ...
          <div className="mb-6">
            {!isConnected ? (
              ...
              <div>
                <div className="relative mb-6 p-6 bg-gray-800/70 rounded-2xl border border-gray-700/50 shadow-lg">
                  {error && (
                    <div className="bg-red-900/30 p-3 rounded-xl mb-4 text-red-300 text-sm">
                      {error}
                    </div>
                  )}
                    ...
                    {paymentVerified ? (
                      ...
                      <>
                        ...
                        <Checkout productId={productId}>
                          <CheckoutButton className="w-full py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:opacity-90 rounded-full shadow-lg font-medium" />
                          <CheckoutStatus />
                        </Checkout>
                      </>
                    )}
          ...
          <div className="mb-6">
            <button
              ...
              className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:opacity-90 py-3 px-6 rounded-full w-full shadow-lg font-medium"
            >
              Predict Birth Time
            </button>
          </div>
