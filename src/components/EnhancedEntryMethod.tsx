...
export function EnhancedEntryMethod({ onSelect }: EnhancedEntryMethodProps) {
  ...
  return (
    <div className="relative w-full max-w-sm mx-auto px-4 mb-16">
      ...
      {/* Main container with glass effect - scaled down for better fit */}
      <motion.div 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
        className="backdrop-blur-xl bg-gray-900/40 border border-gray-700/30 rounded-[28px] p-5 sm:p-6 shadow-2xl relative overflow-hidden scale-90"
      >
        ...
        <div className="relative z-10">
          <motion.h2 
            ...
            className="text-xl sm:text-2xl font-bold text-center mb-4 sm:mb-6 tracking-tight"
          >
          ...
          >
            ...
            >
              <div className="relative mb-2 w-16 h-16 sm:w-20 sm:h-20">
                <motion.div 
                  animate={{ 
              ...
              <h3 className="text-center font-medium text-white text-xs sm:text-sm">Enter Manually</h3>
              <p className="text-center text-gray-400 text-xs mt-1 px-1">Input your birth details directly</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-center font-medium text-white text-xs sm:text-sm">Upload Photo</h3>
              <p className="text-center text-gray-400 text-xs mt-1 px-1">We'll analyze your birth chart</p>
            </motion.div>
          </motion.div>
          ...
          >
            <p className="text-gray-400 text-xs sm:text-xs px-2">
