...
export function EnhancedEntryMethod({ onSelect }: EnhancedEntryMethodProps) {
  ...
  return (
    <div className="relative w-full max-w-md mx-auto px-4 md:px-3 sm:px-2 xs:px-1">
      ...
      <motion.div 
        ...
        className="backdrop-blur-xl bg-gray-900/40 border border-gray-700/30 rounded-[32px] md:rounded-[28px] sm:rounded-[20px] xs:rounded-[16px] p-8 md:p-6 sm:p-4 xs:p-3 shadow-2xl relative overflow-hidden"
      >
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-6 md:gap-4 sm:gap-3 xs:gap-2">
            {/* Manual Entry Option */}
            <motion.button
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-purple-600/20 to-indigo-600/20 rounded-2xl md:rounded-xl sm:rounded-lg xs:rounded-md blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              
              <div className="bg-gray-800/40 backdrop-blur-md hover:bg-gray-800/60 p-6 md:p-5 sm:p-4 xs:p-3 rounded-2xl md:rounded-xl sm:rounded-lg xs:rounded-md transition-all duration-500 border border-gray-700/50 group-hover:border-indigo-500/30 relative overflow-hidden shadow-lg">
                {/* 3D Icon Container */}
                <div className="relative w-24 h-24 md:w-20 md:h-20 sm:w-16 sm:h-16 xs:w-12 xs:h-12 mx-auto mb-4 md:mb-3 sm:mb-2 xs:mb-1.5">
                  ...
                  <motion.div 
                    ...
                    className="absolute inset-0 border-2 border-amber-400/60 rounded-full sm:border-[1.5px] xs:border-1"
                    style={{ 
                  ...
                  >
                    <svg className="w-12 h-12 md:w-10 md:h-10 sm:w-8 sm:h-8 xs:w-6 xs:h-6 text-indigo-100 drop-shadow-[0_2px_3px_rgba(0,0,0,0.4)]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <motion.span 
                  ...
                  className="block font-medium text-lg md:text-base sm:text-sm xs:text-xs text-center text-white mb-1 xs:mb-0.5"
                >
                  Enter Manually
                </motion.span>
                <motion.p 
                  ...
                  className="text-sm md:text-xs sm:text-xs xs:text-[8px] text-center text-gray-300"
                >
            ...
            <motion.button
              ...
              className="relative group"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-600/20 to-purple-600/20 rounded-2xl md:rounded-xl sm:rounded-lg xs:rounded-md blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
