...
export function EnhancedEntryMethod({ onSelect }: EnhancedEntryMethodProps) {
  ...
  return (
    <div className="relative w-full mx-auto px-4 flex justify-center items-center">
      <div 
        style={{ width: containerSize.width }}
        className={`max-w-${containerSize.maxWidth} relative`}
      >
        ...
        <motion.div 
          ...
          className="backdrop-blur-xl bg-gray-900/40 border border-gray-700/30 rounded-[32px] p-4 sm:p-6 md:p-8 shadow-2xl relative overflow-hidden"
        >
          ...
          <div className="relative z-10">
            <motion.h2 
              ...
              className="text-xl sm:text-2xl md:text-3xl font-bold text-center mb-4 sm:mb-6 md:mb-8 tracking-tight"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
              ...
              >
                ...
                <div className="bg-gray-800/40 backdrop-blur-md hover:bg-gray-800/60 p-3 sm:p-4 md:p-6 rounded-2xl transition-all duration-500 border border-gray-700/50 group-hover:border-indigo-500/30 relative overflow-hidden shadow-lg">
                  {/* 3D Icon Container */}
                  <div className="relative w-12 h-12 sm:w-16 sm:h-16 md:w-24 md:h-24 mx-auto mb-3 sm:mb-4" aria-hidden="true">
                    ...
                    >
                      <svg className="w-6 h-6 sm:w-8 sm:h-8 md:w-12 md:h-12 text-indigo-100 drop-shadow-[0_2px_3px_rgba(0,0,0,0.4)]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <motion.span 
                    ...
                    className="block font-medium text-sm sm:text-base md:text-lg text-center text-white mb-1"
                  >
                    Enter Manually
                  </motion.span>
                  <motion.p 
